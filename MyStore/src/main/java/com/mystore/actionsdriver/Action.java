 ...
 * 
 */
package com.mystore.actionsdriver;
...
public class Action extends BaseClass {
	...
	public static boolean JSClick(WebDriver driver, WebElement element) {
	  ...
	  public static void waitTillVisible(WebDriver driver, WebElement element) {
	        WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(20)); // Initialize WebDriverWait with a timeout of 10 seconds
